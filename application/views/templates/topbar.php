                ...
                <div class="dropdown d-none d-sm-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="<?= base_url('lang/en'); ?>" class="dropdown-item notify-item">
                            <img src="<?php echo base_url(); ?>assets/images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                        ...
                        <div data-simplebar style="max-height: 230px;">
                            <a href="" class="text-reset notification-item">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-1">
                                        <h6 class="mt-0 mb-1">Your_order_is_placed</h6>
                                        <div class="font-size-12 text-muted">
                                            <p class="mb-1">If_several_languages_coalesce_the_grammar</p>
                                            <p class="mb-0"><i class="mdi mdi-clock-outline"></i> min_ago</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="" class="text-reset notification-item">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="font-size-12 text-muted">
                                        ...
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i> hours_ago</p>
                                    </div>
                                    </div>
                                </div>
                            </a>
                            <a href="" class="text-reset notification-item">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-1">
                                        <h6 class="mt-0 mb-1">Your_item_is_shipped</h6>
                                        <div class="font-size-12 text-muted">
                                            <p class="mb-1">If_several_languages_coalesce_the_grammar</p>
                                            <p class="mb-0"><i class="mdi mdi-clock-outline"></i> min_ago</p>
                                        </div>
                        ...
                        <div class="p-2 border-top d-grid">
                            <a class="btn btn-sm btn-link font-size-14 " href="javascript:void(0)">
                                <i class="mdi mdi-arrow-right-circle me-3"></i>View_More</a>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="navbar-brand-box">
                    <a href="/" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo base_url(); ?>assets/images/logo-sm.png" alt="logo" height="20">
                        </span>
                        <span class="logo-lg">
                    ...
                    <a href="/" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo base_url(); ?>assets/images/logo-light.png" alt="logo" height="19">
                        </span>
                    </a>
                </div>
                    ...
                    <div class="dropdown-menu dropdown-megamenu">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h5 class="font-size-14">UI_Components</h5>
                                        <ul class="list-unstyled megamenu-list text-muted">
                                            <li>
                                                <a href="javascript:void(0);">Lightbox</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Range_Slider</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Sweet_Alert</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col-md-4">
                                        <h5 class="font-size-14">Extra_Pages</h5>
                                        <ul class="list-unstyled megamenu-list">
                                            <li>
                                                <a href="javascript:void(0);">Light_Sidebar</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Compact_Sidebar</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Horizontal_layout</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Maintenance</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);">Coming_Soon</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col-sm-6">
                                        <div>
                                            <div class="card text-white mb-0 overflow-hidden text-white-50"
                                                style="background-image: url('<?php echo base_url(); ?>assets/images/megamenu-img.png');background-size: cover;">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            ...
                                                            <h5 class="text-white-50">Up_to <span
                                                                    class="font-size-24 text-white">50 %</span> Off</h5>
                                                            <p>At_vero_eos_accusamus_et_iusto_odio</p>
                                                            <div class="mb-4">
                                                                <a href="javascript: void(0);" class="btn btn-success btn-sm">View_more</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
