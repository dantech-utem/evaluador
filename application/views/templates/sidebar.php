<div class="vertical-menu">
    ...
    <div class="user-wid text-center py-4">
            ...
            <div class="mt-3">
                <a href="javascript: void(0);" class="text-dark fw-medium font-size-16"><?php echo $this->session->userdata('nombre_usuario'); ?></a>
        ...
        <div id="sidebar-menu">
            ...
            <div class="sidebar">
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <li><a href="<?php echo site_url() . "/Usuario/C_usuario/Examen"; ?>" class="waves-effect">
                            <i class="mdi mdi-file-document-multiple"></i>
                            <span>Examenes</span>
                        </a></li>
                </li>
