<div class="page-content">
    ...
    <form method="post" action="<?php echo site_url(); ?>/Admin/C_Usuarios/asignarExamen/<?php echo $id_usuarios ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a class="btn btn-danger w-100 waves-effect waves-light" href="<?php echo site_url() . "/Admin/C_Usuarios/R_usuarios"; ?>">Cancelar</a>
                </div>
