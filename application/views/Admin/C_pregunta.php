        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body rounded-0">
                    <h1 class="d-flex justify-content-center">Nueva Pregunta</h1>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="outer-repeater"
                                        action="<?php echo site_url() . '/Usuario/C_Preguntas/Guardarpregunta/'; ?>"
                                        method="post">
                                            ...
                                            <div data-repeater-item class="outer">
                                                ...
                                                <div class="inner-repeater mb-4">
                                                            ...
                                                            <div class="col-md-2 col-2">
                                                                ...
                                                                <div class="form-check form-check-inline">
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="flexRadioDefault1">Correcta</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2 col-4">
                                                                <input data-repeater-delete type="button"
                                                                    class="btn btn-outline-danger w-100 inner"
                                                                    value="Borrar" />
                                                            </div>
                                                    ...
                                                    <input data-repeater-create type="button"
                                                        class="btn btn-outline-success inner" value="Agregar respuesta" />
                                                </div>

                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a class="btn btn-danger w-100 waves-effect waves-light"
                                                            href="<?php echo site_url() . "/Admin/C_Admin/O_pregunta"; ?>"
