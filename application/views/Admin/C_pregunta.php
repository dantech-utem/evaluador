                ...
                <div class="card-body rounded-0">
                   ...
                   <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form  class="outer-repeater" action="<?php echo isset($pregunta) ? site_url().'/Admin/C_Preguntas/updatePreguntas/'.$pregunta->id : site_url().'/Admin/C_Preguntas/Guardarpregunta';?>" method="post">
