<div class="page-content">
    ...
    <a class="btn btn-primary" href="<?php echo site_url() . "/Admin/C_Preguntas/C_pregunta"; ?>"
        class="waves-effect">Crear
        Pregunta</a>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tabla de datos predeterminada</h4>
